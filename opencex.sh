...
mkdir /app/opencex -p
cd /app/opencex || exit
git clone  https://github.com/ryderhiew/OpenCEX-backend ./backend
git clone  https://github.com/ryderhiew/OpenCEX-frontend.git ./frontend
git clone  https://github.com/ryderhiew/OpenCEX-static.git ./nuxt
git clone  https://github.com/ryderhiew/OpenCEX-JS-admin.git ./admin
